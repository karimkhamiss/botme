 ...
 */
final class Version20180807163805 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE cart (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(100) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE client_cart_product (id INT AUTO_INCREMENT NOT NULL, client_id INT NOT NULL, cart_id INT NOT NULL, product_id INT NOT NULL, quantity INT NOT NULL, INDEX IDX_999A6EAB19EB6921 (client_id), INDEX IDX_999A6EAB1AD5CDBF (cart_id), INDEX IDX_999A6EAB4584665A (product_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE client_cart_product DROP FOREIGN KEY FK_999A6EAB1AD5CDBF');
        $this->addSql('ALTER TABLE product DROP FOREIGN KEY FK_D34A04AD12469DE2');
        $this->addSql('ALTER TABLE client_cart_product DROP FOREIGN KEY FK_999A6EAB19EB6921');
        $this->addSql('ALTER TABLE client_cart_product DROP FOREIGN KEY FK_999A6EAB4584665A');
